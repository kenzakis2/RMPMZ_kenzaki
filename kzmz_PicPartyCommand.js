/*:ja
 * @plugindesc パーティーコマンドの画像化（動き有） - v1.00
 * @author 剣崎宗二
 * 
 * @target MZ
 *
 ...
 * 
 * 更新履歴
 * v1.00 - kzmz_PicBattleMenu v1.02をベースに製造
 *
*/
/*~struct~SymbolChart:
 * @param symbol
...
(() => {
    ...
    const script = "kzmz_PicPartyCommand";
    ...
    const kz_Window_PartyCommand_prototype_initialize = Window_PartyCommand.prototype.initialize;
    Window_PartyCommand.prototype.initialize = function (rect) {
        ...
        kz_Window_PartyCommand_prototype_initialize.call(this, properRect);
        if (_windowBack != '') {
    ...
    Window_PartyCommand.prototype.createBackSprite = function () {
    ...
    const kz_Window_PartyCommand_prototype_refresh = Window_PartyCommand.prototype.refresh
    Window_PartyCommand.prototype.refresh = function() {
        kz_Window_PartyCommand_prototype_refresh.call(this);
    ...
    const kz_Window_PartyCommand_prototype__updateCursor = Window_PartyCommand.prototype._updateCursor;
    Window_PartyCommand.prototype._updateCursor = function () {
        kz_Window_PartyCommand_prototype__updateCursor.call(this);
        this._cursorSprite.visible = false;
    };

    Window_PartyCommand.prototype.makeCommandSprites = function () {
        this._commandSprites = [];
        this._list.forEach(function (element, i) {
            ...
            let sprite = new Sprite_BattlePartyCommand(itemData, editedRect, element.symbol, this, i, element.enabled);
    ...
    const kz_Window_PartyCommand_prototype_setHandler = Window_PartyCommand.prototype.setHandler;
    Window_PartyCommand.prototype.setHandler = function (symbol, method) {
        kz_Window_PartyCommand_prototype_setHandler.call(this, symbol, method);
    ...
    const kz_Window_PartyCommand_prototype_itemRect = Window_PartyCommand.prototype.itemRect;
    Window_PartyCommand.prototype.itemRect = function (index) {
        const rect = kz_Window_PartyCommand_prototype_itemRect.call(this, index);
    ...
    const kz_Window_PartyCommand_prototype_select = Window_PartyCommand.prototype.select;
    Window_PartyCommand.prototype.select = function (index) {
        kz_Window_PartyCommand_prototype_select.call(this, index);
        this._commandSprites.forEach(function (element) {
    ...
    const kz_Window_PartyCommand_prototype_ensureCursorVisible = Window_PartyCommand.prototype.ensureCursorVisible
    Window_PartyCommand.prototype.ensureCursorVisible = function (smooth) {
        if (!_cursorDisplay) {
            return false;
        }
        return kz_Window_PartyCommand_prototype_ensureCursorVisible.call(this, smooth);
    };

    const kz_Window_PartyCommand_prototype_processCursorMove = Window_PartyCommand.prototype.processCursorMove;
    Window_PartyCommand.prototype.processCursorMove = function () {
        if (!this.isControlAllowed()) return;
        kz_Window_PartyCommand_prototype_processCursorMove.call(this);
    };

    const kz_Window_PartyCommand_prototype_processHandling = Window_PartyCommand.prototype.processHandling;
    Window_PartyCommand.prototype.processHandling = function () {
        if (!this.isControlAllowed()) return;
        kz_Window_PartyCommand_prototype_processHandling.call(this);
    };

    Window_PartyCommand.prototype.isControlAllowed = function () {
    ...
    function Sprite_BattlePartyCommand() {
        this.initialize.apply(this, arguments);
    }

    Sprite_BattlePartyCommand.prototype = Object.create(Sprite_Clickable.prototype);
    Sprite_BattlePartyCommand.prototype.constructor = Sprite_BattlePartyCommand;

    Sprite_BattlePartyCommand.prototype.initialize = function (cmdData, baseRect, symbol, parent, index, enabled) {
    ...
    Sprite_BattlePartyCommand.prototype.getSymbol = function () {
        return this._symbol;
    };

    Sprite_BattlePartyCommand.prototype.setButtonHandler = function (method) {
        this._buttonHandler = method;
    };

    Sprite_BattlePartyCommand.prototype.update = function () {
    ...
    Sprite_BattlePartyCommand.prototype.updateRectFit = function () {
    ...
    Sprite_BattlePartyCommand.prototype.updateSelected = function () {
    ...
    Sprite_BattlePartyCommand.prototype.updateAnimeMove = function () {
        if (!this.baseRect) {
            this.visible = false;
            return;
        }
    ...
    Sprite_BattlePartyCommand.prototype.onClick = function () {
